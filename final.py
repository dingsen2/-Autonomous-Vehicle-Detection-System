...
class PedestrianBrake():
    def __init__(self):
        ...
        # PID
        self.controller = SpeedController(1)
        ...
        # Stop Sign Detector
        # self.stop_data = cv2.CascadeClassifier('/home/gem/demo_ws/src/vehicle_drivers/gem_gnss_control/scripts/stop_data.xml') # Model 1
        self.stop_data = cv2.CascadeClassifier('/home/gem/demo_ws/src/vehicle_drivers/gem_gnss_control/scripts/stop_sign_classifier_2.xml') # Model 2
    ...
    def detecting(self, frame):
        ...
        if curr_t - self.last_stop_sign > 5:
            print("=======================================================================================================")
